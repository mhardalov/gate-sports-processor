...
public class DocumentTests {
	...
	public void TestSampleResulting() throws Exception {
		String[] documents = { "Шампионът на Италия Ювентус постигна една от най-важните си победи от началото на сезона. "
				...
				"Отборите на Левски и Левски София-Запад завършиха при резултат 7:2 в шестото издание на традиционния коледен двубой по футзал. "
				+ "Срещата се игра в залата в Сливница пред около 1000 зрители. Футболният тим игра с юбилейните жълто-червени екипи и бе представен от клубните легенди Даниел Боримиров, "
				+ "който се отчете с хеттрик, Георги Иванов, Христо Йовов, Елин Топузаков и Станислав Ангелов. Вратар бе младият Станислав Димитров. Левски - София Запад - 7:2+57 Боримиров успя "
				+ "да се разпише още в 3-ата минута след комбинация с Йовов и да изведе Левски напред. Две минути по-късно Пелето покачи на 2:0. Последва натиск на съперника, "
				+ "който не се увенча с успех, а вместо това в 11-ата минута Гонзо с ефектно изпълнение вкара трети гол. Малко след него Йовов пропусна да отбележи. "
				+ "В 17-ата минута обаче Бижутера поправи грешката си и отбеляза за 4:0. В 18-ата минута Димитров прояви страхотен рефлекс след удар на Делян Койчев. "
				+ "В следващата атака Йовов направи още един пропуск. Доминацията на Левски продължи и след почивката и в 24-ата минута Боримиров завърши с точен удар страхотна "
				+ "триходова комбинация. Минута по-късно Александър Димитров отбеляза за София-Запад. След това на игрището се появиха част от юношите на \"сините\", както и "
				+ "Стефан Велев, и София-Запад овладя инициативата. Деян Койчев в 34-ата минута върна още едно попадение. До края на срещата Валентин Добревски също успя да се "
				+ "разпише, а Даниел Боримиров оформи своя хеттрик и любимия за \"сините\" фенове резултат 7:2. В последните минути Гонзо застана на вратата, за да бъде шоуто пълно. "
				+ "Левски - София Запад - 7:2+57 Преди началото на двубоя имаше тържествена програма, а зрителите имаха възможност да спечелят множество награди. В разпределението на "
				+ "наградите участва всеки, закупил дарителски ваучер на цена от 5 лева. 3 лева отиват за подпомагане съществуването на отбора по футзал, а останалите 2 за ще бъдат "
				+ "преведени по сметките на Тръст \"Синя България\" за издаването на книгата \"100 години Левски\". Част от тържеството бяха и мачове между различни формации от школата "
				+ "на Левски, ДИТ и детски отбор на Сливнишки герой. На полуфиналите Левски победи Сливница с 6:0. В другата полуфинална среща ДИТ надделя над Левски-Раковски с 1:0. "
				+ "На финала \"сините\", водени от Веско Сърбаков, удариха ДИТ с минималното 1:0."};
